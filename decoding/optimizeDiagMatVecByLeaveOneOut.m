...
% 
function [allParamVec, logLikelihoodLOODynamics, allParamVecDynamics] = optimizeDiagMatVecByLeaveOneOut(ks, multiSpikeTrains, depVar, rankNum, lowRankMatVec, diagMatVec, elemKernelParams, regCoeff, learningRate)
