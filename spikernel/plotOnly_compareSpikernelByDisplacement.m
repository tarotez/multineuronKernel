...
function plotOnly_compareSpikernelByDisplacement(mse_popSpikernel, mse_mixSpikernel, test_depVar, est_depVar_popSpikernel, est_depVar_mixSpikernel, figID)
...
subplotTitle = 'population rate Spikernel';
origins = test_depVar;
...
positionVector4subplotBoxplot = [0.1, 0.15, 0.42, 0.32];
...
positionVector4subplotBoxplot = [0.53, 0.15, 0.42, 0.32];
showTitle = 1; showXlabel = 0; showYlabel = 0;
scatterDisplacement4subplots(origins4scatter, targets4scatter, test_depVar, period, figID, positionVector4subplotScatter, subplotTitle, showTitle, showXlabel, showYlabel)
showTitle = 0; showXlabel = 1; showYlabel = 0;
boxplotDisplacement4subplots(origins, targets, period, figID, positionVector4subplotBoxplot, subplotTitle, showTitle, showXlabel, showYlabel)
