...
%   errorTensor
%
function errorTensor = forPVC3crossValidateMixtureKernels()
...
trialFoldSize4evaluation = 4;   % sets the number of trials used for test phase of the evaluation.
...
% unitSetNum = 2;   % set to 2 to make it compute fast.a
unitSetNum = 12;   % setting to unitFoldNum = 1 makes it take too much time.
unitSetSize = ceil(unitNum / unitSetNum);
