...
% 
function [allParamVec, logLikelihoodDynamics, allParamVecDynamics, safeLoopCnt] = optimizeSumKernel(likelihoodType, ks, multiSpikeTrainsBySampleID4optimization, depVar, elemKernelParams, regCoeff, learningRate, loopMax, saveIncrement)
