...
% 
function [evalResVec] = grid4sumKernel(evalGridType, ks, multiSpikeTrainsBySampleID4optimization, depVar, elemKernelParamMat, regCoeffVec, stochRMSEtrialNum)
...
for gridPointID = 1:gridPointNum   
    ...
    if abs(sum(elemKernelParams - oldElemKernelParams)) > 0
