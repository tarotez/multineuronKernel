...
function plotOnly_compareDecodingByDisplacement6boxes(test_depVar, est_depVar_popVec_orig, est_depVar_popVec_subt, est_depVar_maxLike_gaussian, est_depVar_maxLike_poisson, est_depVar_poissonRegression, est_depVar_sum_kernel, est_depVar_roufa_kernel)
...
positionVector4subplotScatter = [0.08, 0.625, 0.3, 0.33];
positionVector4subplotBoxplot = [0.08, 0.625, 0.3, 0.33];
...
positionVector4subplotScatter = [0.395, 0.625, 0.3, 0.33];
positionVector4subplotBoxplot = [0.395, 0.625, 0.3, 0.33];
subplotTitle = 'ML const. rate (Gaussian)';
origins = test_depVar;
...
positionVector4subplotScatter = [0.71, 0.625, 0.3, 0.33];
positionVector4subplotBoxplot = [0.71, 0.625, 0.3, 0.33];
subplotTitle = 'ML const. rate (Poisson)';
origins = test_depVar;
origins4scatter = origins + rand(size(origins)) * 4 - 2;
...
positionVector4subplotScatter = [0.08, 0.125, 0.3, 0.33];
positionVector4subplotBoxplot = [0.08, 0.15, 0.3, 0.33];
subplotTitle = 'ML varying rate (spline)';
origins = test_depVar;
origins4scatter = origins + rand(size(origins)) * 4 - 2;
...
% RMSE_poissonRegression = sqrt(mean(meanSquaredErrors));
positionVector4subplot = [0.375, 0.1, 0.3, 0.33];
...
%----
% sum kernel
positionVector4subplotScatter = [0.395, 0.125, 0.3, 0.33];
positionVector4subplotBoxplot = [0.395, 0.15, 0.3, 0.33];
...
%----
% OPRC kernel
positionVector4subplotScatter = [0.71, 0.125, 0.3, 0.33];
positionVector4subplotBoxplot = [0.71, 0.15, 0.3, 0.33];
