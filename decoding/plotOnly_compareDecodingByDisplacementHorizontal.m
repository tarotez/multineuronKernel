...
function plotOnly_compareDecodingByDisplacementHorizontal(test_depVar, est_depVar_popVec_orig, est_depVar_popVec_subt, est_depVar_maxLike_gaussian, est_depVar_maxLike_poisson, est_depVar_poissonRegression, est_depVar_kernel, ksize, offDiag, reg, binSize4poissonRegression, thinConditionsBy, timeLength)
...
positionVector4subplotScatter = [0.05, 0.125, 0.21, 1];
positionVector4subplotBoxplot = [0.05, 0.1, 0.21, 1];
...
positionVector4subplotScatter = [0.33, 0.125, 0.175, 1];
positionVector4subplotBoxplot = [0.33, 0.1, 0.175, 1];
...
positionVector4subplotScatter = [0.57, 0.125, 0.175, 1];
positionVector4subplotBoxplot = [0.57, 0.1, 0.175, 1];
subplotTitle = 'ML spline';
origins = test_depVar;
origins4scatter = origins + rand(size(origins)) * 4 - 2;
...
%}
positionVector4subplotScatter = [0.81, 0.125, 0.175, 1];
positionVector4subplotBoxplot = [0.81, 0.1, 0.175, 1];
