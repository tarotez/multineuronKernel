...
% 
function [allParamVec, logLikelihoodLOODynamics, allParamVecDynamics] = optimizeMixtureMatrixByLeaveOneOut(ks, multiSpikeTrains, depVar, rankNum, lowRankMatVec, diagMatVec, elemKernelParams, regCoeff, learningRate)
