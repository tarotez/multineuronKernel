...
origElemKernelParams = 50;  % time constant of the elementary kernel
origRegCoeff = 0.1;
sgdRandomSampleRatio = 1/2;
learningRate = 1;
kernelType = 'mci'; kernelSpecification = '';
animalID = 8;
disp(['animalID = ' num2str(animalID)])
...
%%% saveIncrement = 5;
loopMax4optimizeElemKernel = 300;
saveIncrement4optimizeElemKernel = 20;
